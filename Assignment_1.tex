...
The train dataset has 4800 observations, and the test dataset has 1200 observations. This a traditional $75\%-25\%$ split of the whole dataset to train the model. Each observation is composed of 68 (x, y) pairs of points. Therefore there are 
\end{answerbox}
